...
config = config()
config.General.requestName = 'clustAlg_TTtoSemiLeptonic_golden_0000' #'diquark_QCD_background_data_0003' #
...
config.Data.outputDatasetTag = 'clustAlg_TTtoSemiLeptonic_golden'
